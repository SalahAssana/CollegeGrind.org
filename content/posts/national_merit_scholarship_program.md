...
featured: false
---
The [National Merit Scholarship Program](https://www.nationalmerit.org/) is a nationwide academic competition that uses the [PSAT/NMSQT](https://satsuite.collegeboard.org/psat-nmsqt/scholarships-recognition/national-merit-scholarship-program) to identify high‑scoring high school juniors and award a relatively small number of scholarships and recognitions. It is run by the National Merit Scholarship Corporation (NMSC), a private, nonprofit organization based in Evanston, Illinois, in partnership with the College Board, which administers the exam.

Each year, about 1.5–1.6 million juniors enter the competition by taking the PSAT/NMSQT; roughly 50,000 of the highest scorers receive some level of National Merit recognition, about 16,000 become Semifinalists, around 15,000 advance to Finalist status, and approximately 7,500 ultimately receive an official National Merit scholarship. While the National Merit name is prestigious, the core program’s own awards are usually modest, usually a [one‑time 2,500‑dollar scholarship](https://web.archive.org/web/20110709134013/http://www.nationalmerit.org/11_Merit2500Scholar.pdf), and the biggest financial impact often comes from colleges that offer their own generous merit aid packages to National Merit Finalists.
...
The National Merit Scholarship Program is a U.S. academic scholarship competition based primarily on performance on the [Preliminary SAT/National Merit Scholarship Qualifying Test (PSAT/NMSQT)](https://satsuite.collegeboard.org/psat-nmsqt/scholarships-recognition/national-merit-scholarship-program). It is designed to recognize and reward high‑achieving high school students and to connect them with scholarship opportunities.

The program was launched in 1955 and is administered by the [National Merit Scholarship Corporation](https://www.nationalmerit.org/), a privately funded nonprofit that operates independently of the federal government. NMSC uses PSAT/NMSQT scores to screen entrants and then runs a [multi‑stage selection process](https://resources.finalsite.net/images/v1685462750/dcsdk12nvus/ffynvesg1ihmmjtrtmbk/NATIONALMERITSCHOLARSHIPPROGRAM.pdf). Moving from Commended and Semifinalist to Finalist and Scholar status to determine who receives recognition and scholarship awards.
...
1. **Entry via PSAT/NMSQT (usually junior year).** Students enter by taking the PSAT/NMSQT at their high school in October of their 11th‑grade year.
2. **Selection Index and initial screening.** NMSC converts PSAT section scores into a Selection Index and identifies about 50,000 top scorers nationwide.
3. **Commended Students and Semifinalists.** About 50,000 top scorers are recognized; around 34–41,000 receive “Commended” status, and about 16–17,000, roughly the top 1 percent in each state, are named Semifinalists.
4. **Finalists.** About 90–95 percent of Semifinalists who meet additional academic, testing, and application requirements become Finalists (roughly 15,000 students).
5. **Scholarship winners (National Merit Scholars).** From the Finalist pool, about 7,000–7,500 receive one of three types of National Merit scholarships: the National Merit 2,500‑dollar scholarship, corporate‑sponsored awards, or college‑sponsored awards.
...
1. Take the test scores for Reading, Writing and Language, and Math.
2. Add them together.
3. Multiply the sum by 2 to obtain a Selection Index between 48 and 228.
...
1. **Strong academic and standardized‑test performers.** Students who naturally test well or who invest substantial time in PSAT/SAT preparation are much more likely to reach the high Selection Index scores needed for Semifinalist and Finalist status.
2. **Students in states with lower Semifinalist cutoffs (slight structural advantage).** Because cutoffs are set to capture roughly the top 1 percent per state, students in less competitive testing pools may qualify with somewhat lower Selection Index scores than peers in high‑cutoff states.
3. **Students flexible about college choice.** The largest financial benefits tend to be at institutions that aggressively recruit National Merit Finalists with large merit scholarships; students willing to attend these colleges can sometimes leverage National Merit into full tuition or full‑ride packages.
4. **Families that understand the rules and timelines.** Students who know to take the PSAT seriously in 11th grade, monitor state cutoff trends, and meet deadlines for declaring a first‑choice college and submitting NMSC materials are better positioned to capture both NMSC and institutional awards.
...
In reality, the official National Merit awards are relatively modest, with the flagship [National Merit scholarship being a one‑time 2,500‑dollar payment](https://www.appily.com/guidance/articles/paying-for-college/everything-about-national-merit-scholarships). Corporate and college‑sponsored awards often range from 500 to a few thousand dollars per year, and [only about half of Finalists receive any official NMSC scholarship](https://cambridge-research.org/blogs/what-is-the-national-merit-scholarship-program/) at all. While roughly [7,500 students win](https://www.cobbk12.org/4-cobb-students-named-winners-of-corporate-sponsored-national-merit-scholarships.65683) an official award, the total [scholarship pool is approximately 33 million dollars](https://event-newsenterprise.com/locals-receive-merit-scholarships/), which is shared across those thousands of winners.

Full‑tuition or [full‑ride packages for National Merit Finalists](https://thescholarshipsystem.com/blog-for-students-families/25-full-ride-scholarships-for-national-merit-finalists/) are typically institutional scholarships offered by [individual colleges](https://meritaidgrids.com/state-level-programs/), not guaranteed by NMSC, and are available only at [specific schools](https://www.collegetransitions.com/dataverse/national-merit-scholarships/) with their own eligibility rules and caps.

### Misconception 2: “Becoming a Finalist automatically pays for college anywhere.”

While Finalist status can help with admissions and may unlock some merit aid, many [highly selective universities](https://www.eduretix.com/post/top-merit-based-scholarships) either do not participate in college‑sponsored National Merit programs or offer only [relatively small awards](https://www.collegetransitions.com/dataverse/national-merit-scholarships/) (for example, 500–2,000 dollars per year). At these schools, National Merit may function more as a prestigious line on the application than as a major source of funding.

### Misconception 3: “The PSAT doesn’t really matter.”

For most students, the PSAT is indeed lower stakes than the SAT. However, for students near the top of the scoring range, the [junior‑year PSAT/NMSQT](https://satsuite.collegeboard.org/psat-nmsqt/scholarships-recognition/national-merit-scholarship-program) is the **sole entry point** into the National Merit competition. [Expert guides](https://blog.prepscholar.com/psat-nmsqt) emphasize there is no second chance to qualify if that test goes poorly. Students cannot use [PSAT 10 or PSAT 8/9 scores](https://resources.finalsite.net/images/v1685462750/dcsdk12nvus/ffynvesg1ihmmjtrtmbk/NATIONALMERITSCHOLARSHIPPROGRAM.pdf) to enter the competition, and while SAT scores are later used to confirm performance, they cannot by themselves substitute for the [initial screening process](https://en.wikipedia.org/wiki/National_Merit_Scholarship_Program) in a normal year.

### Misconception 4: “If you get the 2,500‑dollar award, you’re worse off than if you got a college‑sponsored scholarship.”

This is complex. [NMSC rules state](https://www.reddit.com/r/psat/comments/1fd0tfm/why_would_i_try_on_my_national_merit_scholarship/) that a student may receive only one official National Merit scholarship, so a Finalist who accepts the 2,500‑dollar scholarship cannot also receive an official college‑sponsored National Merit award. However, many [colleges offer separate merit aid](https://meritaidgrids.com/state-level-programs/) for Finalists that are not technically NMSC college‑sponsored awards. This allows students to potentially [stack a 2,500‑dollar stipend](https://talk.collegeconfidential.com/t/2500-nmf-stipend/1801750) with larger [institutional scholarships](https://www.collegetransitions.com/dataverse/national-merit-scholarships/) in some cases.
