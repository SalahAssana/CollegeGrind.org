...
[These colleges enroll a huge share of undergraduates, roughly 40% nationally, and an even larger share of low‑income, first‑generation, and students of color.](https://www.frontiersin.org/article/10.3389/fpsyg.2019.00882/full)

**Open access, not “less than”**

[“Open access” means the college’s mission is to *let people in*](https://files.eric.ed.gov/fulltext/ED579759.pdf), not to sort them out. Community colleges are explicitly designed to provide a pathway into higher education for anyone in the community, including those who:
...
- **“Community college is high school 2.0”**  
  Community college courses are college courses. Many community college classes use the same textbooks and syllabi as nearby universities, and in some fields students who took the course at a community college perform just as well in later professional programs as those who took it at a four‑year university.

- **“Everyone there is underprepared or not serious.”**  
  The “average” community college student is about 28 years old; roughly 45% are first‑generation, and about 80% work while attending. You’ll see honors‑level students aiming at medical or engineering transfers sitting next to students relearning algebra. It’s a *mixed* environment, not a remedial one.

- **“It’s only for people who failed.”**  
...
1. **Access** – Provide an affordable, nearby entry point to college for anyone in the community.
2. **Affordability** – [Keep tuition low enough that federal Pell Grants and modest work income can realistically cover much of the cost.](https://pmc.ncbi.nlm.nih.gov/articles/PMC6472674/)
3. **Workforce & transfer preparation** – Offer:
...
[Community colleges now educate close to 40% of all undergraduates and nearly half of Hispanic undergraduates in the U.S.](https://www.higheredtoday.org/2020/04/20/2020-community-college-snapshot/) They also serve disproportionate numbers of low‑income and working‑class students, who need more support to succeed.

**Structurally underfunded but overburdened**

Here is a key structural tension:

- [Public two‑year colleges receive *less than half* the education‑related revenue per student that public four‑year institutions do.](https://ccrc.tc.columbia.edu/publications/public-funding-community-colleges.html) About 8,700 dollars vs. 17,500 dollars per full‑time‑equivalent student for core academic and support functions.
- [Other analyses estimate community colleges receive around 8,800 dollars less in education revenue per student than public four‑year colleges.](https://www.americanprogress.org/article/78-billion-community-college-funding-shortfall/)
...
[Some research finds that when students maintain strong performance at community colleges and successfully transfer, their bachelor’s completion and later earnings can be comparable to those who started at four‑year institutions.](https://direct.mit.edu/edfp/article/16/3/388/97127/Effects-of-Reduced-Community-College-Tuition-on)
...
[Research in STEM classrooms shows that community colleges can support active, student‑centered teaching and even publishable undergraduate research experiences when resourced and designed well.](https://stemeducationjournal.springeropen.com/articles/10.1186/s40594-020-00251-2)
...
- [**Articulation agreement**](https://www.ubridge.org/blog/articulation-agreements-what-are-they-and-how-do-they-work/): A *formal written agreement* between institutions that spells out which courses will transfer, and how.
- 
...
- [Fewer than **one‑third** of community college starters transfer to a four‑year institution within six years.](https://nscresearchcenter.org/tracking-transfer/)
- Among those who do transfer, **about half** complete a bachelor’s degree in that time.
- Overall, [only around **16% of community college starters** ultimately earn a bachelor’s degree](https://pmc.ncbi.nlm.nih.gov/articles/PMC4375965/), compared with much higher rates for students who start at four‑year colleges.

On top of that:

- When students transfer, they lose [**an average of about 43% of their previously earned credits**](https://www.chepp.org/wp-content/uploads/2024/05/CHEPP_Cost-of-Todays-College-Credit_WHITE-PAPER-003-FINAL.pdf); roughly one in seven lose *all* credits.
- [A federal study found that nearly 40% of transfer students got *no* credit for their prior work, losing on average 27 credits (almost a full year).](https://hechingerreport.org/federal-study-finds-nearly-40-percent-transfer-students-got-credit/)

Surveys of adults who tried to transfer show:

- [About **24%** say only a few or none of their credits were accepted.](https://publicagenda.org/resource/beyond-transfer/findings/)
- [**65%** report at least one negative experience such as repeating classes or losing credits they thought would transfer.](https://publicagenda.org/resource/beyond-transfer/findings/)

### Why credits don’t transfer even when students “do everything right”

Common failure points:

1. **Wrong type of associate degree or major mix**  
   Students complete a workforce‑oriented associate degree (e.g., AAS) when their long‑term goal is a bachelor’s in a different field. Universities may accept the credits as general electives, but *not* count them toward the major or degree requirements.

2. **No specific agreement for the chosen major**  
   An articulation may guarantee admission to the university, but **not** to a particular competitive program (like nursing, engineering, computer science), or not guarantee that major courses will apply.

3. **Course‑by‑course mismatches**  
   Even when credits transfer in, they might show up as “elective” credits rather than satisfying key prerequisites or major requirements. Students then must retake similar content under a different course number at the university.

4. **Policy limits on older credits or certain subjects**  
   Some institutions set time limits on transferability of STEM courses or place extra scrutiny on lab sciences, technical courses, or applied programs.

5. **Information gaps and advising failures**  
   Many students are never clearly told:
   - Which specific four‑year they’re planning toward
...
- [National surveys suggest median academic advising caseloads of roughly **296 students per full‑time advisor**, with community college advisors often handling around **292 students each**.](https://www.bayviewanalytics.com/reports/tyton/tyton2021_drivingtowardadegree_caseload.pdf)
...
1. **Pick a target university and major as early as possible** (even if it changes later).
2. **Use official degree maps from the *destination* university**, not just the community college catalog.
3. **Cross‑check every planned course** against:
...
4. **Keep their own four‑semester plan** that lists:
...
This is the [“hidden curriculum”](https://collegegrind.org/posts/the-hidden-curriculum/) of college: the unwritten rule that students must act as project managers for their own education planning.
...
- [Average annual tuition and fees at public community colleges are about **3,890–4,050 dollars**, vs. around **10,500–11,600 dollars** at in‑state public four‑year institutions.](http://perspectives.acct.org/stories/cost-of-attending-community-college)
- In states like Massachusetts, [policies such as MassTransfer and related tuition credits can further reduce the cost of finishing a bachelor’s after starting at a community college.](https://www.umass.edu/admissions/undergraduate-admissions/apply/masstransfer)

**Pell Grant lifetime limits**

Federal Pell Grants, the main need‑based grant for low‑income students, have a hard cap:

- Students can receive Pell for the equivalent of [**12 full‑time semesters (600% “Lifetime Eligibility Used”)**](https://www.nwti.edu/page/pell-lifetime-eligibility), total, across all colleges.
...
- Community college students overall have lower on‑time completion. [Only about **32%** of first‑time, full‑time students at two‑year institutions graduate within 150% of program time (three years for a two‑year degree), and many never complete.](https://journals.sagepub.com/doi/10.1177/23328584231186618)

When students lose credits, change majors late, or have to repeat coursework, the financial equation can flip:

- Savings from two years of lower community college tuition
  **vs.**
...
- [More than **half (about 56%)** of community college credit credentials are workforce or career‑technical awards.](https://ccrc.tc.columbia.edu/easyblog/community-college-awards-for-post-completion-success.html)
- Many workforce programs, especially in health, industrial trades, and certain technologies, produce strong earnings boosts. For example, [in California, associate degrees in CTE fields were linked to roughly **25–33% higher earnings**, with large variation by field.](https://poverty.ucdavis.edu/sites/main/files/file-attachments/cpr-stevens_cte_returns_brief_0.pdf)
...
[Research shows that starting at a community college can depress bachelor’s completion compared to starting at a four‑year college *when transfer pathways are weak and advising is limited*.](https://dash.harvard.edu/bitstream/1/34298861/1/jole_preprint.pdf)
...
1. **“I want a specific job as soon as possible.”**  
   → Focus on workforce programs with strong, *documented* wage outcomes and employer demand in your region. Ask to see data on job placement and median earnings by program.

2. **“I want a bachelor’s degree.”**  
   → Treat community college as the first half of a four‑year plan, not a separate project.
   - Pick likely target universities and majors as early as you can.
   - Prioritize transfer‑oriented degrees (AA/AS) that explicitly align with those majors.

3. **“I’m not sure yet; I need to explore affordably.”**  
   → Use general education requirements smartly.
   - Focus on courses that satisfy widely transferable gen‑ed packages (like a 34‑credit MassTransfer Gen Ed Foundation in MA, or IGETC/CSU Breadth in CA).
...
If you are in Massachusetts, for example, explore [MassTransfer A2B Mapped Pathways](https://www.mass.edu/masstransfer/a2b/programsearch-maps.asp), which lay out exactly which community college courses will transfer and apply to specific state universities and UMass majors.
...
- **Choosing a university**  
  How to evaluate four‑year colleges for cost, support, outcomes, and cultural fit crucial if you plan to transfer.

- **Choosing classes**  
  How to use catalogs, degree audits, and transfer maps to build term‑by‑term schedules that move you toward your goal instead of sideways.

- **Financial aid basics**  
  Understanding Pell Grants, loans, work‑study, lifetime eligibility, satisfactory academic progress, and how aid changes when you transfer.
...
- **What they’re designed to do**  
  Provide open, affordable entry into college and the workforce for a broad community, including many students that the rest of higher education underserves, on far fewer dollars per student than four‑year institutions.

- **When they are a smart strategic choice**
